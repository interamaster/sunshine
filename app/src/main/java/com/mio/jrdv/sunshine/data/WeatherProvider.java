...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        // 1)  All paths added to the UriMatcher have a corresponding code to return when a match is
        // found.
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                ...
                //aqui devolvemos 1 sola fila luego  un item:
            ...
            case WEATHER_WITH_LOCATION:
                ...
                //aqui devolvemos un cursor con varias filas...luego un dir:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER: {
                //retCursor = null;
                //VAMOS A PSARLE LOS PARAMETROS DE LA FUNCION:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //Y AHORA NOTIFICAMOS A TODOS LOS CONTENT OBSERVER!!:
